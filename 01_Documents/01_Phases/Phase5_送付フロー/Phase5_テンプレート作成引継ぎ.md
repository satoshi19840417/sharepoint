...
| ファイル | 場所 |
|----------|------|
| 指摘まとめ | `01_Documents/01_Phases/Phase5_送付フロー/Phase5_送付フロー_指摘まとめ.md` |
| タスク管理表 | `01_Documents/01_Phases/Phase5_送付フロー/Phase5_テンプレート作成タスク.md` |
| 計画書 | `01_Documents/01_Phases/Phase5_送付フロー/Phase5_送付フロー計画書.md` |
| 修正計画 | `01_Documents/01_Phases/Phase5_送付フロー/Phase5_テンプレート修正計画.md` |
| 修正スクリプト | `01_Documents/01_Phases/Phase5_送付フロー/modify_word_template.py` |
| 発注書テンプレート | `01_Documents/02_Templates/発注書テンプレート.docx` |
