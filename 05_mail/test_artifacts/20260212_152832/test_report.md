...
- Run ID: `20260212_152832`
- Stage: `stage2`
- Mail Scope: `self`
- Generated: `2026-02-12T15:28:49.402973`
- Artifact Dir: `C:\Users\千賀聡志\OneDrive - セルジェンテック株式会社\sharepointリスト化\05_mail\test_artifacts\20260212_152832`
...
| TC-58 | PASS | Self-addressed test send should succeed. | message_id=<OSCPR01MB146944D8BF6E929BEC9A3362FC860A@OSCPR01MB14694.jpnprd01.prod.outlook.com> |  | - |
...
| TC-63 | PASS | Successful send should obtain non-fallback Message-ID. | message_id=<OSCPR01MB1469412006FEA4EFAF62DFDBFC860A@OSCPR01MB14694.jpnprd01.prod.outlook.com> |  | - |
...
| TC-86 | BLOCKED | Unsent-list rerun with *_enc should work (known implementation gap). | Stage 'stage2' excludes this test case. | Not executed due to stage filter. | - |
