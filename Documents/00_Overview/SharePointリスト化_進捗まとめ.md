...
| タスク | ステータス | 詳細 |
|--------|-----------|------|
| **Phase 5 テンプレート作成** | ✅ 完了 (Rev7改修済) | [タスク管理表](../01_Phases/Phase5_送付フロー/Phase5_テンプレート作成タスク.md) |
| **Phase 5 準備 (列追加)** | 📋 未着手 | [Phase5_送付フロー計画書](../01_Phases/Phase5_送付フロー/Phase5_送付フロー計画書.md) |
...
|-------|------|-----------|--------|
| 1-4 | 購買申請・承認フロー | ✅ 運用中 | - |
| 5 | 承認後送付フロー | 🔄 準備中 | [Phase5_送付フロー計画書.md](../01_Phases/Phase5_送付フロー/Phase5_送付フロー計画書.md) |
