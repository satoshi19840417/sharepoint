...
**ファイル**: `CGT発注書_サンプル.xlsx`（`Documents/03_DataSamples/`）
...
2. 業者マスタCSV読込: SharePoint「/Shared Documents/マスタ/業者連絡先.csv」
...
#### [NEW] `Documents/02_Templates/発注書テンプレート.docx`
- Content Control方式で差し込みフィールド埋め込み
- コントロール名はSP内部名に統一

#### [NEW] `Documents/02_Templates/請書テンプレート.xlsx`
- 計算セル（小計・税・合計）は数式保持
- 業者入力欄（納期・サイン）のみ編集許可
- シート保護設定済み
