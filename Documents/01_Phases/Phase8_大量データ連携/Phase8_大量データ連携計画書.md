...
| **アーカイブ先** | SharePoint文書ライブラリ `Documents/Archives/YYYY/` |
...
| 3 | アーカイブフォルダへアップロード | 管理者 | 同上 | `Documents/Archives/YYYY/` へ配置 |
...
|-----------|---------|---------|-----------|--------|
| 出庫記録_2021-2023.xlsx | 2021/4〜2023/3 | Documents/Archives/2021-2023/ | 2023-03-31 | 管理者A |
| 出庫記録_2023-2025.xlsx | 2023/4〜2025/3 | Documents/Archives/2023-2025/ | 2025-03-31 | 管理者B |
| 出庫記録_現行.xlsx | 2025/4〜現在 | Documents/Current/ | 随時 | 全員 |
...
| **保存場所** | SharePoint文書ライブラリ `Documents/Reports/` |
...
【スコープ: メイン処理】
  ...
  アクション3: Excelファイルのテーブルをクリア
    - ファイル: Documents/Reports/出庫記録_分析用.xlsx
    - テーブル: Table1
  ↓
...
【通知】
  ...
  アクション12: 成功通知メール送信（オプション）
    ...
    - 本文:
      ...
      ファイルパス: Documents/Reports/出庫記録_分析用.xlsx
      ```
```
...
| 3 | アーカイブフォルダ構造作成 | 管理者 | 同上 | - | `Documents/Archives/YYYY/` |
...
| 10 | アーカイブCSVのアップロード | 管理者 | 同上 | #9完了 | `Documents/Archives/YYYY/` に配置 |
...
| 9 | **Archivesフォルダへアップロード** | SharePoint `Documents/Archives/YYYY/` へ各CSV配置 | フォルダ構造を事前作成 |
